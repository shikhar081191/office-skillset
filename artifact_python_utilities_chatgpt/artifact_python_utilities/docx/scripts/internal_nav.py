...
def main() -> None:
    ap = argparse.ArgumentParser(description="Add internal navigation links/bookmarks and a static TOC")
    ap.add_argument("input_docx")
    ap.add_argument("--out", required=True)
    ap.add_argument("--toc_title", default="Table of Contents")
    ap.add_argument("--levels", nargs="+", type=int, default=[1, 2, 3], help="Heading levels to include")
    ap.add_argument("--no_quicklinks", action="store_true", help="Disable quick links bar")
    ap.add_argument("--no_back_to_toc", action="store_true", help="Do not add back-to-TOC links on headings")
